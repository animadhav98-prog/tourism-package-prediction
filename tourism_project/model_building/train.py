...
mlflow.set_experiment("tourism-prediction-expt")

api = HfApi()


Xtrain_path = "hf://datasets/ani-maddy98/tourism-package-prediction/Xtrain.csv"
Xtest_path = "hf://datasets/ani-maddy98/tourism-package-prediction/Xtest.csv"
ytrain_path = "hf://datasets/ani-maddy98/tourism-package-prediction/ytrain.csv"
ytest_path = "hf://datasets/ani-maddy98/tourism-package-prediction/ytest.csv"
...
with mlflow.start_run():
    ...
    repo_id = "ani-maddy98/prediction-model"
    repo_type = "model"
    ...
    # create_repo("prediction-model", repo_type="model", private=False)
    api.upload_file(
